    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.assesses.update", [$assess->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="isu" id="isu" value="{{ old('isu', $assess->isu) }}" required>
                            @if($errors->has('isu'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('isu') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="risiko" id="risiko" value="{{ old('risiko', $assess->risiko) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tindakan_pengendalian" id="tindakan_pengendalian" value="{{ old('tindakan_pengendalian', $assess->tindakan_pengendalian) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tinjut_penanganan" id="tinjut_penanganan" value="{{ old('tinjut_penanganan', $assess->tinjut_penanganan) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="persetujuan_tindakan" id="persetujuan_tindakan" value="{{ old('persetujuan_tindakan', $assess->persetujuan_tindakan) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="target_penyelesaian" id="target_penyelesaian" value="{{ old('target_penyelesaian', $assess->target_penyelesaian) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="penanggung_jawab" id="penanggung_jawab" value="{{ old('penanggung_jawab', $assess->penanggung_jawab) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tinjut_residual" id="tinjut_residual" value="{{ old('tinjut_residual', $assess->tinjut_residual) }}">
