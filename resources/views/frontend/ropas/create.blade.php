                        ...
                        <div class="bs-stepper">
                            ...
                            <div class="bs-stepper-content">
                                <div id="section1-part" class="content" role="tabpanel"
                                    aria-labelledby="section1-part-trigger">
                                    <div class="form-group">
                                        <label class="required"
                                            for="unit_kerja">{{ trans('cruds.ropa.fields.unit_kerja') }}</label>
                                        <select class="form-control" name="unit_kerja" id="unit_kerja" required>
                                            <option value disabled
                                                {{ old('unit_kerja', null) === null ? 'selected' : '' }}>
                                                {{ trans('global.pleaseSelect') }}</option>
                                            @foreach($organization as $key => $label)
                                            <option value="{{ $key }}"
                                                {{ old('unit_kerja', '') === (string) $key ? 'selected' : '' }}>
                                                {{ $label }}</option>
                                            @endforeach
                                        </select>
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.unit_kerja_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label class="required"
                                    ...
                                    <div class="form-group">
                                        <label class="required"
                                            for="fungsi">{{ trans('cruds.ropa.fields.fungsi') }}</label>
                                        <input class="form-control" type="text" name="fungsi" id="fungsi"
                                    ...
                                    <div class="form-group">
                                        <label class="required"
                                            for="proses_bisnis">{{ trans('cruds.ropa.fields.proses_bisnis') }}</label>
                                        <input class="form-control" type="text" name="proses_bisnis" id="proses_bisnis"
                                            value="{{ old('proses_bisnis', '') }}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="jenis_data" id="jenis_data" required>
                                            <option value disabled
                                                {{ old('jenis_data', null) === null ? 'selected' : '' }}>
                                                {{ trans('global.pleaseSelect') }}</option>
                                            @foreach(App\Models\Ropa::JENIS_DATA_SELECT as $key => $label)
                                            <option value="{{ $key }}"
                                                {{ old('jenis_data', '') === (string) $key ? 'selected' : '' }}>
                                                {{ $label }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.jenis_data_helper') }}</span>
                                    </div>
                                    <a class="btn btn-primary" onclick="stepper.next()"><i
                                            class="fa fa-chevron-right"></i> Next</a>
                                </div>
                                <div id="section2-part" class="content" role="tabpanel"
                                    aria-labelledby="section2-part-trigger">
                                    <div class="form-group">
                                        <h3> Data Bersifat Umum</h3><p style="color:red">*Centang apabila data tersebut ada dalam proses bisnis</p>
                                        <div>
                                            <input type="hidden" name="umum_nama_lengkap" value="0">
                                            <input type="checkbox" name="umum_nama_lengkap" id="umum_nama_lengkap"
                                                value="1" {{ old('umum_nama_lengkap', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="umum_nama_lengkap">{{ trans('cruds.ropa.fields.umum_nama_lengkap') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.umum_nama_lengkap_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="umum_jenkel" value="0">
                                            <input type="checkbox" name="umum_jenkel" id="umum_jenkel" value="1"
                                                {{ old('umum_jenkel', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="umum_jenkel">{{ trans('cruds.ropa.fields.umum_jenkel') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.umum_jenkel_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="umum_kewarganegaraan" value="0">
                                            <input type="checkbox" name="umum_kewarganegaraan" id="umum_kewarganegaraan"
                                                value="1" {{ old('umum_kewarganegaraan', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="umum_kewarganegaraan">{{ trans('cruds.ropa.fields.umum_kewarganegaraan') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.umum_kewarganegaraan_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="umum_agama" value="0">
                                            <input type="checkbox" name="umum_agama" id="umum_agama" value="1"
                                                {{ old('umum_agama', 0) == 1 ? 'checked' : '' }}>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.umum_agama_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="umum_kawin" value="0">
                                            <input type="checkbox" name="umum_kawin" id="umum_kawin" value="1"
                                                {{ old('umum_kawin', 0) == 1 ? 'checked' : '' }}>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.umum_kawin_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label class="required"
                                            for="umum_kombinasi">{{ trans('cruds.ropa.fields.umum_kombinasi') }}</label>
                                        <input class="form-control" type="text" name="umum_kombinasi"
                                            id="umum_kombinasi" value="{{ old('umum_kombinasi', '') }}" required>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.umum_kombinasi_helper') }}</span>
                                    </div>

                                    <h3>Data Bersifat Spesifik</h3><p style="color:red">*Centang apabila data tersebut ada dalam proses bisnis</p>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="spesifik_sehat" value="0">
                                            <input type="checkbox" name="spesifik_sehat" id="spesifik_sehat" value="1"
                                                {{ old('spesifik_sehat', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="spesifik_sehat">{{ trans('cruds.ropa.fields.spesifik_sehat') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.spesifik_sehat_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="spesifik_biometrik" value="0">
                                            <input type="checkbox" name="spesifik_biometrik" id="spesifik_biometrik"
                                                value="1" {{ old('spesifik_biometrik', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="spesifik_biometrik">{{ trans('cruds.ropa.fields.spesifik_biometrik') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.spesifik_biometrik_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="spesifik_genetik" value="0">
                                            <input type="checkbox" name="spesifik_genetik" id="spesifik_genetik"
                                                value="1" {{ old('spesifik_genetik', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="spesifik_genetik">{{ trans('cruds.ropa.fields.spesifik_genetik') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.spesifik_genetik_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="spesifik_jahat" value="0">
                                            <input type="checkbox" name="spesifik_jahat" id="spesifik_jahat" value="1"
                                                {{ old('spesifik_jahat', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="spesifik_jahat">{{ trans('cruds.ropa.fields.spesifik_jahat') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.spesifik_jahat_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="spesifik_anak" value="0">
                                            <input type="checkbox" name="spesifik_anak" id="spesifik_anak" value="1"
                                                {{ old('spesifik_anak', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="spesifik_anak">{{ trans('cruds.ropa.fields.spesifik_anak') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.spesifik_anak_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="spesifik_uang" value="0">
                                            <input type="checkbox" name="spesifik_uang" id="spesifik_uang" value="1"
                                                {{ old('spesifik_uang', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="spesifik_uang">{{ trans('cruds.ropa.fields.spesifik_uang') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.spesifik_uang_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label
                                            for="spesifik_lain">{{ trans('cruds.ropa.fields.spesifik_lain') }}</label>
                                        <input class="form-control" type="text" name="spesifik_lain" id="spesifik_lain"
                                            value="{{ old('spesifik_lain', '') }}">
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.spesifik_lain_helper') }}</span>
                                    </div>

                                    <h3>Format Data Pribadi</h3>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="format_elektronik" value="0">
                                            <input type="checkbox" name="format_elektronik" id="format_elektronik"
                                                value="1" {{ old('format_elektronik', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="format_elektronik">{{ trans('cruds.ropa.fields.format_elektronik') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.format_elektronik_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="format_nonelektronik" value="0">
                                            <input type="checkbox" name="format_nonelektronik" id="format_nonelektronik"
                                                value="1" {{ old('format_nonelektronik', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="format_nonelektronik">{{ trans('cruds.ropa.fields.format_nonelektronik') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.format_nonelektronik_helper') }}</span>
                                    </div>
                                ...
                                <div id="section3-part" class="content" role="tabpanel"
                                    aria-labelledby="section3-part-trigger">
                                    <h3>Pengumpulan Data</h3>
                                    <div class="form-group">
                                        <label class="required"
                                            for="tujuan">{{ trans('cruds.ropa.fields.tujuan') }}</label>
                                    ...
                                    <div class="form-group">
                                        <label class="required"
                                            for="owner">{{ trans('cruds.ropa.fields.owner') }}</label>
                                    ...
                                    <div class="form-group">
                                        <label class="required"
                                            for="sumber">{{ trans('cruds.ropa.fields.sumber') }}</label>
                                    ...
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <input type="checkbox" name="simpan_divsendiri" id="simpan_divsendiri"
                                                value="1" {{ old('simpan_divsendiri', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="simpan_divsendiri">{{ trans('cruds.ropa.fields.simpan_divsendiri') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.simpan_divsendiri_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="simpan_divlain" value="0">
                                            <input type="checkbox" name="simpan_divlain" id="simpan_divlain" value="1"
                                                {{ old('simpan_divlain', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="simpan_divlain">{{ trans('cruds.ropa.fields.simpan_divlain') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.simpan_divlain_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="simpan_vendor" value="0">
                                            <input type="checkbox" name="simpan_vendor" id="simpan_vendor" value="1"
                                                {{ old('simpan_vendor', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="simpan_vendor">{{ trans('cruds.ropa.fields.simpan_vendor') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.simpan_vendor_helper') }}</span>
                                    </div>
                                    <h3>Deskripsi Keamanan Teknis (jika ada)</h3>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="aman_akses" value="0">
                                            <input type="checkbox" name="aman_akses" id="aman_akses" value="1"
                                                {{ old('aman_akses', 0) == 1 ? 'checked' : '' }}>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.aman_akses_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="aman_enkripsi" value="0">
                                            <input type="checkbox" name="aman_enkripsi" id="aman_enkripsi" value="1"
                                                {{ old('aman_enkripsi', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="aman_enkripsi">{{ trans('cruds.ropa.fields.aman_enkripsi') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.aman_enkripsi_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="aman_otentikasi" value="0">
                                            <input type="checkbox" name="aman_otentikasi" id="aman_otentikasi" value="1"
                                                {{ old('aman_otentikasi', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="aman_otentikasi">{{ trans('cruds.ropa.fields.aman_otentikasi') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.aman_otentikasi_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label for="aman_lainnya">{{ trans('cruds.ropa.fields.aman_lainnya') }}</label>
                                        <input class="form-control" type="text" name="aman_lainnya" id="aman_lainnya"
                                            value="{{ old('aman_lainnya', '') }}">
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.aman_lainnya_helper') }}</span>
                                    </div>
                                    <h3>Pemrosesan Data</h3>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="proses_olehkumpul" value="0">
                                            <input type="checkbox" name="proses_olehkumpul" id="proses_olehkumpul"
                                                value="1" {{ old('proses_olehkumpul', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="proses_olehkumpul">{{ trans('cruds.ropa.fields.proses_olehkumpul') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.proses_olehkumpul_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="proses_olahanalisis" value="0">
                                            <input type="checkbox" name="proses_olahanalisis" id="proses_olahanalisis"
                                                value="1" {{ old('proses_olahanalisis', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="proses_olahanalisis">{{ trans('cruds.ropa.fields.proses_olahanalisis') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.proses_olahanalisis_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="proses_simpan" value="0">
                                            <input type="checkbox" name="proses_simpan" id="proses_simpan" value="1"
                                                {{ old('proses_simpan', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="proses_simpan">{{ trans('cruds.ropa.fields.proses_simpan') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.proses_simpan_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="proses_baik" value="0">
                                            <input type="checkbox" name="proses_baik" id="proses_baik" value="1"
                                                {{ old('proses_baik', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="proses_baik">{{ trans('cruds.ropa.fields.proses_baik') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.proses_baik_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="proses_tampil" value="0">
                                            <input type="checkbox" name="proses_tampil" id="proses_tampil" value="1"
                                                {{ old('proses_tampil', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="proses_tampil">{{ trans('cruds.ropa.fields.proses_tampil') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.proses_tampil_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <div>
                                            <input type="hidden" name="proses_hapus" value="0">
                                            <input type="checkbox" name="proses_hapus" id="proses_hapus" value="1"
                                                {{ old('proses_hapus', 0) == 1 ? 'checked' : '' }}>
                                            <label
                                                for="proses_hapus">{{ trans('cruds.ropa.fields.proses_hapus') }}</label>
                                        </div>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.proses_hapus_helper') }}</span>
                                    </div>
                                    <a class="btn btn-primary" onclick="stepper.previous()"><i
                                            class="fa fa-chevron-left"></i> Previous</a>
                                    <a class="btn btn-primary" onclick="stepper.next()"><i
                                ...
                                <div id="section4-part" class="content" role="tabpanel"
                                    aria-labelledby="section4-part-trigger">
                                    <h3>Aliran Data</h3>
                                    <div class="form-group">
                                        <label class="required"
                                            for="aliran_input">{{ trans('cruds.ropa.fields.aliran_input') }}</label>
                                        <input class="form-control" type="text" name="aliran_input" id="aliran_input"
                                            value="{{ old('aliran_input', '') }}" required>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.aliran_input_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label class="required"
                                            for="aliran_output">{{ trans('cruds.ropa.fields.aliran_output') }}</label>
                                        <input class="form-control" type="text" name="aliran_output" id="aliran_output"
                                            value="{{ old('aliran_output', '') }}" required>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.aliran_output_helper') }}</span>
                                    </div>
                                    <h3>Transfer ke Pihak Eksternal</h3>
                                    <div class="form-group">
                                        <label
                                            for="transfer_tujuan">{{ trans('cruds.ropa.fields.transfer_tujuan') }}</label>
                                        <input class="form-control" type="text" name="transfer_tujuan"
                                            id="transfer_tujuan" value="{{ old('transfer_tujuan', '') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.transfer_metode_helper') }}</span>
                                    </div>

                                    <h3>Retensi dan Disposal</h3>
                                    <div class="form-group">
                                        <label class="required"
                                            for="retensi_periode">{{ trans('cruds.ropa.fields.retensi_periode') }}</label>
                                        <input class="form-control" type="text" name="retensi_periode"
                                            id="retensi_periode" value="{{ old('retensi_periode', '') }}" required>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.retensi_periode_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label class="required"
                                            for="retensi_metode">{{ trans('cruds.ropa.fields.retensi_metode') }}</label>
                                        <input class="form-control" type="text" name="retensi_metode"
                                            id="retensi_metode" value="{{ old('retensi_metode', '') }}" required>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.ropa.fields.retensi_metode_helper') }}</span>
                                    </div>
                                    <a class="btn btn-primary" onclick="stepper.previous()"><i
                                            class="fa fa-chevron-left"></i> Previous</a>
                                    <a class="btn btn-primary" onclick="stepper.next()"><i
                            ...
                            <div id="section5-part" class="content" role="tabpanel"
                                ...
                                <div class="form-group">
                                    <div>
                                        ...
                                        <input type="checkbox" name="join_pihak" id="join_pihak" value="1"
                                            {{ old('join_pihak', 0) == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div>
                                        ...
                                        <input type="checkbox" name="join_janji" id="join_janji" value="1"
                                            {{ old('join_janji', 0) == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div>
                                        ...
                                        <input type="checkbox" name="join_tujuan" id="join_tujuan" value="1"
                                            {{ old('join_tujuan', 0) == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div>
                                        ...
                                        <input type="checkbox" name="join_pic" id="join_pic" value="1"
                                            {{ old('join_pic', 0) == 1 ? 'checked' : '' }}>
