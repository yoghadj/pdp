    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.ropas.update", [$ropa->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="unit_kerja">{{ trans('cruds.ropa.fields.unit_kerja') }}</label>
                            <input class="form-control" type="text" name="unit_kerja" id="unit_kerja" value="{{ old('unit_kerja', $ropa->unit_kerja) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sub_unit" id="sub_unit" value="{{ old('sub_unit', $ropa->sub_unit) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fungsi" id="fungsi" value="{{ old('fungsi', $ropa->fungsi) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pic" id="pic" value="{{ old('pic', $ropa->pic) }}" required>
                            @if($errors->has('pic'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('pic') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="proses_bisnis" id="proses_bisnis" value="{{ old('proses_bisnis', $ropa->proses_bisnis) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="umum_nama_lengkap" id="umum_nama_lengkap" value="1" {{ $ropa->umum_nama_lengkap || old('umum_nama_lengkap', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="umum_jenkel" id="umum_jenkel" value="1" {{ $ropa->umum_jenkel || old('umum_jenkel', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="umum_kewarganegaraan" id="umum_kewarganegaraan" value="1" {{ $ropa->umum_kewarganegaraan || old('umum_kewarganegaraan', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="umum_agama" id="umum_agama" value="1" {{ $ropa->umum_agama || old('umum_agama', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="umum_kawin" id="umum_kawin" value="1" {{ $ropa->umum_kawin || old('umum_kawin', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="umum_kombinasi" id="umum_kombinasi" value="{{ old('umum_kombinasi', $ropa->umum_kombinasi) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="spesifik_sehat" id="spesifik_sehat" value="1" {{ $ropa->spesifik_sehat || old('spesifik_sehat', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="spesifik_biometrik" id="spesifik_biometrik" value="1" {{ $ropa->spesifik_biometrik || old('spesifik_biometrik', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="spesifik_genetik" id="spesifik_genetik" value="1" {{ $ropa->spesifik_genetik || old('spesifik_genetik', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="spesifik_jahat" id="spesifik_jahat" value="1" {{ $ropa->spesifik_jahat || old('spesifik_jahat', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="spesifik_anak" id="spesifik_anak" value="1" {{ $ropa->spesifik_anak || old('spesifik_anak', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="spesifik_uang" id="spesifik_uang" value="1" {{ $ropa->spesifik_uang || old('spesifik_uang', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="spesifik_lain" id="spesifik_lain" value="{{ old('spesifik_lain', $ropa->spesifik_lain) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="format_elektronik" id="format_elektronik" value="1" {{ $ropa->format_elektronik || old('format_elektronik', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="format_nonelektronik" id="format_nonelektronik" value="1" {{ $ropa->format_nonelektronik || old('format_nonelektronik', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tujuan" id="tujuan" value="{{ old('tujuan', $ropa->tujuan) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="owner" id="owner" value="{{ old('owner', $ropa->owner) }}" required>
                            @if($errors->has('owner'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('owner') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sumber" id="sumber" value="{{ old('sumber', $ropa->sumber) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="simpan_divsendiri" id="simpan_divsendiri" value="1" {{ $ropa->simpan_divsendiri || old('simpan_divsendiri', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="simpan_divlain" id="simpan_divlain" value="1" {{ $ropa->simpan_divlain || old('simpan_divlain', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="simpan_vendor" id="simpan_vendor" value="1" {{ $ropa->simpan_vendor || old('simpan_vendor', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="aman_akses" id="aman_akses" value="1" {{ $ropa->aman_akses || old('aman_akses', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="aman_enkripsi" id="aman_enkripsi" value="1" {{ $ropa->aman_enkripsi || old('aman_enkripsi', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="aman_otentikasi" id="aman_otentikasi" value="1" {{ $ropa->aman_otentikasi || old('aman_otentikasi', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="aman_lainnya" id="aman_lainnya" value="{{ old('aman_lainnya', $ropa->aman_lainnya) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="proses_olehkumpul" id="proses_olehkumpul" value="1" {{ $ropa->proses_olehkumpul || old('proses_olehkumpul', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="proses_olahanalisis" id="proses_olahanalisis" value="1" {{ $ropa->proses_olahanalisis || old('proses_olahanalisis', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="proses_simpan" id="proses_simpan" value="1" {{ $ropa->proses_simpan || old('proses_simpan', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="proses_baik" id="proses_baik" value="1" {{ $ropa->proses_baik || old('proses_baik', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="proses_tampil" id="proses_tampil" value="1" {{ $ropa->proses_tampil || old('proses_tampil', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="proses_hapus" id="proses_hapus" value="1" {{ $ropa->proses_hapus || old('proses_hapus', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="aliran_input" id="aliran_input" value="{{ old('aliran_input', $ropa->aliran_input) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="aliran_output" id="aliran_output" value="{{ old('aliran_output', $ropa->aliran_output) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="transfer_tujuan" id="transfer_tujuan" value="{{ old('transfer_tujuan', $ropa->transfer_tujuan) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="retensi_periode" id="retensi_periode" value="{{ old('retensi_periode', $ropa->retensi_periode) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="retensi_metode" id="retensi_metode" value="{{ old('retensi_metode', $ropa->retensi_metode) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="konsen_kumpul" id="konsen_kumpul" value="1" {{ $ropa->konsen_kumpul || old('konsen_kumpul', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="konsen_wajib" id="konsen_wajib" value="{{ old('konsen_wajib', $ropa->konsen_wajib) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="konsen_aturan" id="konsen_aturan" value="1" {{ $ropa->konsen_aturan || old('konsen_aturan', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="konsen_vital" id="konsen_vital" value="1" {{ $ropa->konsen_vital || old('konsen_vital', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="konsen_umum" id="konsen_umum" value="1" {{ $ropa->konsen_umum || old('konsen_umum', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="konsen_lain" id="konsen_lain" value="1" {{ $ropa->konsen_lain || old('konsen_lain', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="aplikasi" id="aplikasi" value="{{ old('aplikasi', $ropa->aplikasi) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="implementasi_tujuan" id="implementasi_tujuan" value="1" {{ $ropa->implementasi_tujuan || old('implementasi_tujuan', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="implementasi_update" id="implementasi_update" value="1" {{ $ropa->implementasi_update || old('implementasi_update', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="implementasi_akses" id="implementasi_akses" value="1" {{ $ropa->implementasi_akses || old('implementasi_akses', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="implementasi_hapus" id="implementasi_hapus" value="1" {{ $ropa->implementasi_hapus || old('implementasi_hapus', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="implementasi_tarik" id="implementasi_tarik" value="1" {{ $ropa->implementasi_tarik || old('implementasi_tarik', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="implementasi_berat" id="implementasi_berat" value="1" {{ $ropa->implementasi_berat || old('implementasi_berat', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="implementasi_tunda" id="implementasi_tunda" value="1" {{ $ropa->implementasi_tunda || old('implementasi_tunda', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="implementasi_rugi" id="implementasi_rugi" value="1" {{ $ropa->implementasi_rugi || old('implementasi_rugi', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="implementasi_pakai" id="implementasi_pakai" value="1" {{ $ropa->implementasi_pakai || old('implementasi_pakai', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="implementasi_kirim" id="implementasi_kirim" value="1" {{ $ropa->implementasi_kirim || old('implementasi_kirim', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="join_pihak" id="join_pihak" value="1" {{ $ropa->join_pihak || old('join_pihak', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="join_janji" id="join_janji" value="1" {{ $ropa->join_janji || old('join_janji', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="join_tujuan" id="join_tujuan" value="1" {{ $ropa->join_tujuan || old('join_tujuan', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="join_pic" id="join_pic" value="1" {{ $ropa->join_pic || old('join_pic', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status" id="status" required>
                                ...
                                @foreach(App\Models\Ropa::STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('status', $ropa->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
