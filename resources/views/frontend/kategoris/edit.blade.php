    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.kategoris.update", [$kategori->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="proses">{{ trans('cruds.kategori.fields.proses') }}</label>
                            <input class="form-control" type="text" name="proses" id="proses" value="{{ old('proses', $kategori->proses) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="stakeholder" id="stakeholder" value="{{ old('stakeholder', $kategori->stakeholder) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="kriteria_hukum" id="kriteria_hukum" value="1" {{ $kategori->kriteria_hukum || old('kriteria_hukum', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="kriteria_spesifik" id="kriteria_spesifik" value="1" {{ $kategori->kriteria_spesifik || old('kriteria_spesifik', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="kriteria_besar" id="kriteria_besar" value="1" {{ $kategori->kriteria_besar || old('kriteria_besar', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="kriteria_evaluasi" id="kriteria_evaluasi" value="1" {{ $kategori->kriteria_evaluasi || old('kriteria_evaluasi', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="kriteria_cocok" id="kriteria_cocok" value="1" {{ $kategori->kriteria_cocok || old('kriteria_cocok', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="kriteria_teknologi" id="kriteria_teknologi" value="1" {{ $kategori->kriteria_teknologi || old('kriteria_teknologi', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="kriteria_batas" id="kriteria_batas" value="1" {{ $kategori->kriteria_batas || old('kriteria_batas', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="pia" id="pia" value="1" {{ $kategori->pia || old('pia', 0) === 1 ? 'checked' : '' }}>
