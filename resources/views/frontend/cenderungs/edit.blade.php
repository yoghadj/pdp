    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.cenderungs.update", [$cenderung->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="nilai">{{ trans('cruds.cenderung.fields.nilai') }}</label>
                            <input class="form-control" type="number" name="nilai" id="nilai" value="{{ old('nilai', $cenderung->nilai) }}" step="1" required>
                            @if($errors->has('nilai'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pola" id="pola" value="{{ old('pola', $cenderung->pola) }}" required>
                            @if($errors->has('pola'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('pola') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="kemungkinan" id="kemungkinan" value="{{ old('kemungkinan', $cenderung->kemungkinan) }}" required>
