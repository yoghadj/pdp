    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.dampaks.update", [$dampak->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="nilai">{{ trans('cruds.dampak.fields.nilai') }}</label>
                            <input class="form-control" type="number" name="nilai" id="nilai" value="{{ old('nilai', $dampak->nilai) }}" step="1" required>
                            @if($errors->has('nilai'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="finansial" id="finansial" value="{{ old('finansial', $dampak->finansial) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="compliance" id="compliance" value="{{ old('compliance', $dampak->compliance) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="reputasi" id="reputasi" value="{{ old('reputasi', $dampak->reputasi) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="dampak" id="dampak" value="{{ old('dampak', $dampak->dampak) }}" required>
