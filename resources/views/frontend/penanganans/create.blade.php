    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.penanganans.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="min">{{ trans('cruds.penanganan.fields.min') }}</label>
                            <input class="form-control" type="number" name="min" id="min" value="{{ old('min', '') }}" step="1" required>
                            @if($errors->has('min'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="max" id="max" value="{{ old('max', '') }}" step="1" required>
                            @if($errors->has('max'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('max') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="penanganan" id="penanganan" value="{{ old('penanganan', '') }}" required>
