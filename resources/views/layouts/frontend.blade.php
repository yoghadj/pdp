                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('ropa_access')
                                        <a class="dropdown-item" href="{{ route('frontend.ropas.index') }}">
                                    ...
                                    @can('cenderung_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.cenderungs.index') }}">
                                            {{ trans('cruds.cenderung.title') }}
                                        </a>
                                    @endcan
                                    @can('dampak_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.dampaks.index') }}">
                                            {{ trans('cruds.dampak.title') }}
                                        </a>
                                    @endcan
                                    @can('cenderung_dampak_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.cenderung-dampaks.index') }}">
                                            {{ trans('cruds.cenderungDampak.title') }}
                                        </a>
                                    @endcan
                                    @can('penanganan_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.penanganans.index') }}">
                                    ...
                                    @endcan
                                    @can('kategori_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.kategoris.index') }}">
                                            {{ trans('cruds.kategori.title') }}
                                        </a>
                                    @endcan
                                    @can('assess_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.assesses.index') }}">
