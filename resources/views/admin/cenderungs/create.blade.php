...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.cenderungs.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pola') ? 'is-invalid' : '' }}" type="text" name="pola" id="pola" value="{{ old('pola', '') }}" required>
                @if($errors->has('pola'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kemungkinan') ? 'is-invalid' : '' }}" type="text" name="kemungkinan" id="kemungkinan" value="{{ old('kemungkinan', '') }}" required>
