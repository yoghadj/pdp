...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.dampaks.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('finansial') ? 'is-invalid' : '' }}" type="text" name="finansial" id="finansial" value="{{ old('finansial', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('compliance') ? 'is-invalid' : '' }}" type="text" name="compliance" id="compliance" value="{{ old('compliance', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reputasi') ? 'is-invalid' : '' }}" type="text" name="reputasi" id="reputasi" value="{{ old('reputasi', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dampak') ? 'is-invalid' : '' }}" type="text" name="dampak" id="dampak" value="{{ old('dampak', '') }}" required>
