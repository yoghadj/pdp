...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.assess.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.assesses.update", [$assess->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('proses') ? 'is-invalid' : '' }}" name="proses_id" id="proses_id" required>
                    @foreach($proses as $id => $entry)
                        <option value="{{ $id }}" {{ (old('proses_id') ? old('proses_id') : $assess->proses->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('isu') ? 'is-invalid' : '' }}" type="text" name="isu" id="isu" value="{{ old('isu', $assess->isu) }}" required>
                @if($errors->has('isu'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('risiko') ? 'is-invalid' : '' }}" type="text" name="risiko" id="risiko" value="{{ old('risiko', $assess->risiko) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nilai_kemungkinan') ? 'is-invalid' : '' }}" name="nilai_kemungkinan_id" id="nilai_kemungkinan_id" required>
                    @foreach($nilai_kemungkinans as $id => $entry)
                        <option value="{{ $id }}" {{ (old('nilai_kemungkinan_id') ? old('nilai_kemungkinan_id') : $assess->nilai_kemungkinan->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nilai_dampak') ? 'is-invalid' : '' }}" name="nilai_dampak_id" id="nilai_dampak_id" required>
                    @foreach($nilai_dampaks as $id => $entry)
                        <option value="{{ $id }}" {{ (old('nilai_dampak_id') ? old('nilai_dampak_id') : $assess->nilai_dampak->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tindakan_pengendalian') ? 'is-invalid' : '' }}" type="text" name="tindakan_pengendalian" id="tindakan_pengendalian" value="{{ old('tindakan_pengendalian', $assess->tindakan_pengendalian) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nilai_kontrol_kemungkinan') ? 'is-invalid' : '' }}" name="nilai_kontrol_kemungkinan_id" id="nilai_kontrol_kemungkinan_id">
                    @foreach($nilai_kontrol_kemungkinans as $id => $entry)
                        <option value="{{ $id }}" {{ (old('nilai_kontrol_kemungkinan_id') ? old('nilai_kontrol_kemungkinan_id') : $assess->nilai_kontrol_kemungkinan->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nilai_kontrol_dampak') ? 'is-invalid' : '' }}" name="nilai_kontrol_dampak_id" id="nilai_kontrol_dampak_id">
                    @foreach($nilai_kontrol_dampaks as $id => $entry)
                        <option value="{{ $id }}" {{ (old('nilai_kontrol_dampak_id') ? old('nilai_kontrol_dampak_id') : $assess->nilai_kontrol_dampak->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tindakan') ? 'is-invalid' : '' }}" name="tindakan" id="tindakan">
                    ...
                    @foreach(App\Models\Assess::TINDAKAN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tindakan', $assess->tindakan) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tinjut_penanganan') ? 'is-invalid' : '' }}" type="text" name="tinjut_penanganan" id="tinjut_penanganan" value="{{ old('tinjut_penanganan', $assess->tinjut_penanganan) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('persetujuan_tindakan') ? 'is-invalid' : '' }}" type="text" name="persetujuan_tindakan" id="persetujuan_tindakan" value="{{ old('persetujuan_tindakan', $assess->persetujuan_tindakan) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('target_penyelesaian') ? 'is-invalid' : '' }}" type="text" name="target_penyelesaian" id="target_penyelesaian" value="{{ old('target_penyelesaian', $assess->target_penyelesaian) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                    ...
                    @foreach(App\Models\Assess::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $assess->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('penanggung_jawab') ? 'is-invalid' : '' }}" type="text" name="penanggung_jawab" id="penanggung_jawab" value="{{ old('penanggung_jawab', $assess->penanggung_jawab) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nilai_residu_kemungkinan') ? 'is-invalid' : '' }}" name="nilai_residu_kemungkinan_id" id="nilai_residu_kemungkinan_id">
                    @foreach($nilai_residu_kemungkinans as $id => $entry)
                        <option value="{{ $id }}" {{ (old('nilai_residu_kemungkinan_id') ? old('nilai_residu_kemungkinan_id') : $assess->nilai_residu_kemungkinan->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nilai_residu_dampak') ? 'is-invalid' : '' }}" name="nilai_residu_dampak_id" id="nilai_residu_dampak_id">
                    @foreach($nilai_residu_dampaks as $id => $entry)
                        <option value="{{ $id }}" {{ (old('nilai_residu_dampak_id') ? old('nilai_residu_dampak_id') : $assess->nilai_residu_dampak->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tindakan_residu') ? 'is-invalid' : '' }}" name="tindakan_residu" id="tindakan_residu">
                    ...
                    @foreach(App\Models\Assess::TINDAKAN_RESIDU_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tindakan_residu', $assess->tindakan_residu) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tinjut_residual') ? 'is-invalid' : '' }}" type="text" name="tinjut_residual" id="tinjut_residual" value="{{ old('tinjut_residual', $assess->tinjut_residual) }}">
