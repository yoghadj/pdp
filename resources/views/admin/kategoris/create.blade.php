...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.kategoris.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="proses">{{ trans('cruds.kategori.fields.proses') }}</label>
                <input class="form-control {{ $errors->has('proses') ? 'is-invalid' : '' }}" type="text" name="proses" id="proses" value="{{ old('proses', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stakeholder') ? 'is-invalid' : '' }}" type="text" name="stakeholder" id="stakeholder" value="{{ old('stakeholder', '') }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('kriteria_hukum') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="kriteria_hukum" id="kriteria_hukum" value="1" {{ old('kriteria_hukum', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('kriteria_spesifik') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="kriteria_spesifik" id="kriteria_spesifik" value="1" {{ old('kriteria_spesifik', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('kriteria_besar') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="kriteria_besar" id="kriteria_besar" value="1" {{ old('kriteria_besar', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('kriteria_evaluasi') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="kriteria_evaluasi" id="kriteria_evaluasi" value="1" {{ old('kriteria_evaluasi', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('kriteria_cocok') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="kriteria_cocok" id="kriteria_cocok" value="1" {{ old('kriteria_cocok', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('kriteria_teknologi') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="kriteria_teknologi" id="kriteria_teknologi" value="1" {{ old('kriteria_teknologi', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('kriteria_batas') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="kriteria_batas" id="kriteria_batas" value="1" {{ old('kriteria_batas', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('pia') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="pia" id="pia" value="1" {{ old('pia', 0) == 1 ? 'checked' : '' }}>
