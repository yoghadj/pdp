    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.ropas.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sub_unit') ? 'is-invalid' : '' }}" type="text" name="sub_unit" id="sub_unit" value="{{ old('sub_unit', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fungsi') ? 'is-invalid' : '' }}" type="text" name="fungsi" id="fungsi" value="{{ old('fungsi', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('proses_bisnis') ? 'is-invalid' : '' }}" type="text" name="proses_bisnis" id="proses_bisnis" value="{{ old('proses_bisnis', '') }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('umum_nama_lengkap') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="umum_nama_lengkap" id="umum_nama_lengkap" value="1" {{ old('umum_nama_lengkap', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('umum_jenkel') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="umum_jenkel" id="umum_jenkel" value="1" {{ old('umum_jenkel', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('umum_kewarganegaraan') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="umum_kewarganegaraan" id="umum_kewarganegaraan" value="1" {{ old('umum_kewarganegaraan', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('umum_agama') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="umum_agama" id="umum_agama" value="1" {{ old('umum_agama', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('umum_kawin') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="umum_kawin" id="umum_kawin" value="1" {{ old('umum_kawin', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('umum_kombinasi') ? 'is-invalid' : '' }}" type="text" name="umum_kombinasi" id="umum_kombinasi" value="{{ old('umum_kombinasi', '') }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('spesifik_sehat') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="spesifik_sehat" id="spesifik_sehat" value="1" {{ old('spesifik_sehat', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('spesifik_biometrik') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="spesifik_biometrik" id="spesifik_biometrik" value="1" {{ old('spesifik_biometrik', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('spesifik_genetik') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="spesifik_genetik" id="spesifik_genetik" value="1" {{ old('spesifik_genetik', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('spesifik_jahat') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="spesifik_jahat" id="spesifik_jahat" value="1" {{ old('spesifik_jahat', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('spesifik_anak') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="spesifik_anak" id="spesifik_anak" value="1" {{ old('spesifik_anak', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('spesifik_uang') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="spesifik_uang" id="spesifik_uang" value="1" {{ old('spesifik_uang', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spesifik_lain') ? 'is-invalid' : '' }}" type="text" name="spesifik_lain" id="spesifik_lain" value="{{ old('spesifik_lain', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('format_elektronik') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="format_elektronik" id="format_elektronik" value="1" {{ old('format_elektronik', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('format_nonelektronik') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="format_nonelektronik" id="format_nonelektronik" value="1" {{ old('format_nonelektronik', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sumber') ? 'is-invalid' : '' }}" type="text" name="sumber" id="sumber" value="{{ old('sumber', '') }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('simpan_divsendiri') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="simpan_divsendiri" id="simpan_divsendiri" value="1" {{ old('simpan_divsendiri', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('simpan_divlain') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="simpan_divlain" id="simpan_divlain" value="1" {{ old('simpan_divlain', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('simpan_vendor') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="simpan_vendor" id="simpan_vendor" value="1" {{ old('simpan_vendor', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('aman_akses') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="aman_akses" id="aman_akses" value="1" {{ old('aman_akses', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('aman_enkripsi') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="aman_enkripsi" id="aman_enkripsi" value="1" {{ old('aman_enkripsi', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('aman_otentikasi') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="aman_otentikasi" id="aman_otentikasi" value="1" {{ old('aman_otentikasi', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aman_lainnya') ? 'is-invalid' : '' }}" type="text" name="aman_lainnya" id="aman_lainnya" value="{{ old('aman_lainnya', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('proses_olehkumpul') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="proses_olehkumpul" id="proses_olehkumpul" value="1" {{ old('proses_olehkumpul', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('proses_olahanalisis') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="proses_olahanalisis" id="proses_olahanalisis" value="1" {{ old('proses_olahanalisis', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('proses_simpan') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="proses_simpan" id="proses_simpan" value="1" {{ old('proses_simpan', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('proses_baik') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="proses_baik" id="proses_baik" value="1" {{ old('proses_baik', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('proses_tampil') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="proses_tampil" id="proses_tampil" value="1" {{ old('proses_tampil', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('proses_hapus') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="proses_hapus" id="proses_hapus" value="1" {{ old('proses_hapus', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aliran_input') ? 'is-invalid' : '' }}" type="text" name="aliran_input" id="aliran_input" value="{{ old('aliran_input', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aliran_output') ? 'is-invalid' : '' }}" type="text" name="aliran_output" id="aliran_output" value="{{ old('aliran_output', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transfer_tujuan') ? 'is-invalid' : '' }}" type="text" name="transfer_tujuan" id="transfer_tujuan" value="{{ old('transfer_tujuan', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('retensi_periode') ? 'is-invalid' : '' }}" type="text" name="retensi_periode" id="retensi_periode" value="{{ old('retensi_periode', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('retensi_metode') ? 'is-invalid' : '' }}" type="text" name="retensi_metode" id="retensi_metode" value="{{ old('retensi_metode', '') }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('konsen_kumpul') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="konsen_kumpul" id="konsen_kumpul" value="1" {{ old('konsen_kumpul', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('konsen_wajib') ? 'is-invalid' : '' }}" type="text" name="konsen_wajib" id="konsen_wajib" value="{{ old('konsen_wajib', '') }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('konsen_aturan') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="konsen_aturan" id="konsen_aturan" value="1" {{ old('konsen_aturan', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('konsen_vital') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="konsen_vital" id="konsen_vital" value="1" {{ old('konsen_vital', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('konsen_umum') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="konsen_umum" id="konsen_umum" value="1" {{ old('konsen_umum', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('konsen_lain') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="konsen_lain" id="konsen_lain" value="1" {{ old('konsen_lain', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aplikasi') ? 'is-invalid' : '' }}" type="text" name="aplikasi" id="aplikasi" value="{{ old('aplikasi', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('implementasi_tujuan') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="implementasi_tujuan" id="implementasi_tujuan" value="1" {{ old('implementasi_tujuan', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('implementasi_update') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="implementasi_update" id="implementasi_update" value="1" {{ old('implementasi_update', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('implementasi_akses') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="implementasi_akses" id="implementasi_akses" value="1" {{ old('implementasi_akses', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('implementasi_hapus') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="implementasi_hapus" id="implementasi_hapus" value="1" {{ old('implementasi_hapus', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('implementasi_tarik') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="implementasi_tarik" id="implementasi_tarik" value="1" {{ old('implementasi_tarik', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('implementasi_berat') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="implementasi_berat" id="implementasi_berat" value="1" {{ old('implementasi_berat', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('implementasi_tunda') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="implementasi_tunda" id="implementasi_tunda" value="1" {{ old('implementasi_tunda', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('implementasi_rugi') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="implementasi_rugi" id="implementasi_rugi" value="1" {{ old('implementasi_rugi', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('implementasi_pakai') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="implementasi_pakai" id="implementasi_pakai" value="1" {{ old('implementasi_pakai', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('implementasi_kirim') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="implementasi_kirim" id="implementasi_kirim" value="1" {{ old('implementasi_kirim', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('join_pihak') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="join_pihak" id="join_pihak" value="1" {{ old('join_pihak', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('join_janji') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="join_janji" id="join_janji" value="1" {{ old('join_janji', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('join_tujuan') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="join_tujuan" id="join_tujuan" value="1" {{ old('join_tujuan', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('join_pic') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="join_pic" id="join_pic" value="1" {{ old('join_pic', 0) == 1 ? 'checked' : '' }}>
