...
class AssessController extends Controller
{
    public function index()
    {
        ...
        return view('admin.assesses.index', compact('assesses'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.assesses.create', compact('nilai_dampaks', 'nilai_kemungkinans', 'nilai_kontrol_dampaks', 'nilai_kontrol_kemungkinans', 'nilai_residu_dampaks', 'nilai_residu_kemungkinans', 'proses'));
    }
    ...
    public function store(StoreAssessRequest $request)
    {
        ...
        return redirect()->route('admin.assesses.index');
    }
    ...
    public function edit(Assess $assess)
    {
        ...
        return view('admin.assesses.edit', compact('assess', 'nilai_dampaks', 'nilai_kemungkinans', 'nilai_kontrol_dampaks', 'nilai_kontrol_kemungkinans', 'nilai_residu_dampaks', 'nilai_residu_kemungkinans', 'proses'));
    }
    ...
    public function show(Assess $assess)
    {
        ...
        return view('admin.assesses.show', compact('assess'));
    }
