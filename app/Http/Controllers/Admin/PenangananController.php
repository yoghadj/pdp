...
class PenangananController extends Controller
{
    public function index()
    {
        ...
        return view('admin.penanganans.index', compact('penanganans'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.penanganans.create');
    }
    ...
    public function store(StorePenangananRequest $request)
    {
        ...
        return redirect()->route('admin.penanganans.index');
    }
    ...
    public function edit(Penanganan $penanganan)
    {
        ...
        return view('admin.penanganans.edit', compact('penanganan'));
    }
    ...
    public function show(Penanganan $penanganan)
    {
        ...
        return view('admin.penanganans.show', compact('penanganan'));
    }
