...
class KategoriController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.kategoris.index', compact('kategoris'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.kategoris.create');
    }
    ...
    public function store(StoreKategoriRequest $request)
    {
        ...
        return redirect()->route('frontend.kategoris.index');
    }
    ...
    public function edit(Kategori $kategori)
    {
        ...
        return view('frontend.kategoris.edit', compact('kategori'));
    }
    ...
    public function show(Kategori $kategori)
    {
        ...
        return view('frontend.kategoris.show', compact('kategori'));
    }
